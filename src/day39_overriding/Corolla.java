...
public class Corolla extends Toyota{
   ...
   protected String hiz="Corolla max 200 km hiz kullanir";
   protected String yakit="Corolla benzinli veya elektriklidir";
  protected String model="Corolla";

    public void motor(){
        System.out.println("Corolla araclar cevreci kullanir");
    }

    public void yakitTuketimi(){
        System.out.println("Corolla araclar 5.6 yakit tuketirler");
    }
    public void vitesSayisi(){
        ...
        System.out.println(arb1.hareket);// araba classi
        ...
        System.out.println(arb2.hareket);// araba classi
       ...
       // System.out.println(arb2.model);//CTE
        ...
        System.out.println(arb3.hareket);// araba classi
