...
public class C01_LocaleDate {
    public static void main(String[] args) {
        LocalDate trh= LocalDate.now();// objenin olusturtudugu tarihi trh ye atar
        LocalDate baskaTrh=LocalDate.of(1990,10,20);
        //istedeigimiz yil,ay ve gun degerlerine gore bize obje olusturur
        ...
        System.out.println(trh.getDayOfMonth());//3
